<div>
    <div class="flex">
        <div class="text-center shadow m-2 w-1/2 p-2 rounded-lg border border-blue-600">
            <h1 class="">Fecha: <input class="border sm:w-full lg:w-auto hover:border-blue-600" type="date" name="fecha" wire:change="fecha()" wire:model='fechaFact' value="{{ old("fechaFact") }}"></h1>
