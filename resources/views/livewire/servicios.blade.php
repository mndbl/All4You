<div class="shadow m-2 p-2 rounded-lg border border-blue-600">
    ...
    <div class="w-auto mt-2 sm:block lg:flex space-x-2">
        @if ($interc)
        ...
        <div class="block">
            ...
            <input class="sm:w-1/3 lg:w-1/2 border border-blue-600" id="cuotas" name="cuotas" wire:model='cuota' type="number" placeholder="Cuotas" {{ $tipoContrato == "Convenio" ? "autofocus" : "disabled" }} />
            @error('cuota') <span class="error">{{ $message }}</span> @enderror
        </div>
        <div class="block">
            <label for="precio">Monto: </label>
            <input class="sm:w-1/3 lg:w-1/2 border border-blue-600" id="precio" name="precio" wire:model='precio' type="number" placeholder="Monto" {{ $tipoContrato == "Convenio" ? "" : "disabled" }} />
